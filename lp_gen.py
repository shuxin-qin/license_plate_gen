...
if __name__ == '__main__':
    Gen = GenPlate("./data/font/platech.ttf", './data/font/platechar.ttf', './data/envirment')
    #Gen.genBatch(10, 'data/generate/train', (226, 105), num=7, special=0)
    Gen.generatePlate(2000, '../data/oneline_8', 2)
